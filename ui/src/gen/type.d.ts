...
> = (...args: [...Parameters<T>, ...Parameters<U>]) => ReturnType<U>;
/**
 ...
 */
export type tsServerOutputEvent =
  | 'projectLoadingStart'
 ...
 */
export type onTsServerResponse = (
 ...
 */
export type tsServerEditFile = (
  args: import('typescript').server.protocol.ChangeRequestArgs,
) => void;
/**
 ...
 */
export type tsServerCompletion = (
  args: import('typescript').server.protocol.CompletionsRequestArgs,
) => void;
/**
